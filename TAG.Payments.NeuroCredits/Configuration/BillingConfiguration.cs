...
namespace TAG.Payments.NeuroCredits.Configuration
{
    ...
    public class BillingConfiguration
    {
        ...
        public static async Task<BillingConfiguration> Load()
        {
            ...
            Result.Reference = await RuntimeSettings.GetAsync(Prefix + ".Billing.Reference", string.Empty);
            Result.SenderAddress = await RuntimeSettings.GetAsync(Prefix + ".Billing.SenderAddress", string.Empty);
            Result.SenderCountry = await RuntimeSettings.GetAsync(Prefix + ".Billing.SenderCountry", string.Empty);
            Result.WebPage = await RuntimeSettings.GetAsync(Prefix + ".Billing.WebPage", string.Empty);
